...
public class SshService {
    ...
    // session.setConfig("cipher.c2s", "aes256-ctr,aes192-ctr,aes128-ctr");
        ...
        reader.close();
            ...
            e.printStackTrace();
            result.append("Failed to connect or execute command: " + e.getMessage());
        }
    ...
    // session.setConfig("cipher.c2s", "aes256-ctr,aes192-ctr,aes128-ctr");
            ...
            if (vendorName.equals("Juniper")) endCommand = "exit\n";
            else if (vendorName.equals("Nokia")) endCommand = "logout\n";

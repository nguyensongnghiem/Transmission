...
public class FoContractController {
    ...
    public String showCreateForm(Model model) {
        model.addAttribute("foContractDTO", new FoContractUpdateDTO());
        return "/contract/contract-create";
    }

    // save new to DB
    @PostMapping("/create")
    public String create(@Valid @ModelAttribute FoContractUpdateDTO foContractDTO, BindingResult bindingResult,
        ...
        if (excelUploadService.isValidExcelFile(file)) {
            try {
                ...
                hiredFoLines.forEach(hiredFoLine -> {
                    hiredFoLine.setFoContract(targetFoContract);
                });
    ...
    public String showEditForm(Model model, @PathVariable(name = "editId") int editId) {
        ...
        FoContractUpdateDTO foContractDTO = new FoContractUpdateDTO();
    ...
    @PostMapping("/edit")
    public String edit(@Valid @ModelAttribute FoContractUpdateDTO foContractDTO, BindingResult bindingResult) {
        FoContract targetFoContract = new FoContract();
